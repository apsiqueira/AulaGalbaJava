 ...
 * @author Estacio
 */
public class frmaePrincipal extends javax.swing.JFrame {

    /**
     * Creates new form frmaePrincipal
     */
    public frmaePrincipal() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmaePrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmaePrincipal().setVisible(true);
            }
        });
    }
